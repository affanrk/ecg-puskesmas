    ...
    useEffect(() => {
        ...
        const observer = new ResizeObserver((entries) => {
            for (const entry of entries) {
                ...
                // Header is exactly 50px (h-[50px]). Row is exactly 48px (h-[48px]).
                    ...
                    <table className="w-full h-full text-left border-collapse table-fixed lg:table-auto">
                        <thead className="bg-slate-50/50 text-slate-400 sticky top-0 z-10 backdrop-blur-sm h-[50px]">
                            <tr>
                                ...
                                <th className="px-3 sm:px-4 lg:px-6 font-black text-xs uppercase tracking-[0.15em] border-b border-slate-100 whitespace-nowrap">Device ID</th>
                                <th className="px-3 sm:px-4 lg:px-6 font-black text-xs uppercase tracking-[0.15em] border-b border-slate-100 whitespace-nowrap">Subject NIK</th>
