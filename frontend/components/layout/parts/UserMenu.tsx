        ...
        <div className="relative" ref={menuRef}>
            ...
            >
                <div className="text-right hidden md:block">
                    <p className="text-xs font-bold text-slate-700 leading-tight group-hover:text-teal-700 transition-colors">
                        {user ? ((getActiveProfile(user)?.full_name || "") || user.username) : 'Loading...'}
                    </p>
                ...
                <div className={clsx(
                    ...
                    {user ? user.username.charAt(0).toUpperCase() : <UserIcon size={18} />}
                </div>
