        ...
        <div className="flex flex-col sm:flex-row items-center justify-between sm:h-14 2xl:h-20 border-b border-slate-100 bg-white/80 backdrop-blur-md shrink-0 select-none z-30 sticky top-0">
            <div className="flex items-center justify-between w-full sm:w-56 2xl:w-80 gap-3 px-3 sm:px-5 2xl:px-8 border-r border-slate-100 h-full shrink-0">
                ...
                <div className="flex items-center gap-3 sm:gap-4 2xl:gap-6 flex-1 sm:flex-none justify-center">
                    <button 
                        onClick={onToday}
                        className="px-3 py-1 2xl:px-5 2xl:py-2 bg-white border border-slate-200 rounded-md text-[9px] sm:text-[10px] 2xl:text-xs font-black text-slate-600 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm uppercase tracking-widest"
                    >
                        Today
                    </button>
                    ...
                    <div className="flex items-center bg-slate-50 p-1 2xl:p-1.5 rounded-md border border-slate-100 sm:ml-1">
                        ...
                        <button onClick={onNext} className="p-1 sm:p-1 2xl:p-1.5 rounded-md hover:bg-white hover:shadow-sm text-slate-500 transition-all active:scale-90">
            ...
            <div className="flex-1 flex items-center justify-between px-3 sm:px-5 2xl:px-8 h-full min-w-0">
                <div className="flex items-center gap-1 2xl:gap-2">
                    <div className="relative" ref={monthRef}>
                        <button 
                            ...
                            className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 2xl:px-4 py-2 hover:bg-slate-50 rounded-md transition-all group border border-transparent hover:border-slate-100"
                        >
                                    ...
                                    {months.map((m, idx) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={clsx(
                                                    "flex items-center justify-between px-3 py-2 2xl:px-4 2xl:py-3 rounded-md text-xs 2xl:text-sm transition-all",
                                    ...
                                    {yearNodes.sort((a,b) => b.value - a.value).map((node) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={clsx(
                                                    "flex items-center justify-between px-4 py-2.5 2xl:px-5 2xl:py-3.5 rounded-md text-xs 2xl:text-sm transition-all",
                                                    isSelected ? "bg-blue-600 text-white font-bold shadow-md shadow-blue-100" : "text-slate-600 hover:bg-slate-50 font-bold"
                                                )}
                                            >
                ...
                <div className="flex items-center justify-center bg-slate-100/80 p-1 2xl:p-1.5 rounded-lg border border-slate-200/50 relative overflow-hidden">
                    ...
                    <button
                        ...
                        className={clsx(
                            "relative z-10 px-4 sm:px-6 2xl:px-8 py-1.5 sm:py-2 2xl:py-3 text-[9px] sm:text-[10px] 2xl:text-xs font-black uppercase tracking-widest transition-colors duration-300 rounded-md",
