                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
                    ...
                    <div className="bg-white w-full max-w-xl max-h-[90vh] overflow-hidden rounded-md shadow-xl relative flex flex-col z-10 mx-auto">
                        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
                            ...
                            <button onClick={() => setSelectedResult({ data: null })} className="p-2 hover:bg-slate-100 rounded-full text-slate-400 transition-colors cursor-pointer">
                        ...
                        <div className="px-6 py-4 border-t border-slate-100 flex justify-end bg-slate-50/50">
                            <button onClick={() => setSelectedResult({ data: null })} className="px-8 py-2.5 bg-slate-900 text-white rounded-lg text-[11px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all active:scale-95 shadow-lg shadow-slate-200 cursor-pointer">
                                Tutup Analisis
                            </button>
                        </div>
                    </div>
