...
import OperatorIdentityCard from './parts/OperatorIdentityCard';
import OperatorContactCard from './parts/OperatorContactCard';
import OperatorUsernameCard from './parts/OperatorUsernameCard';
import OperatorPasswordCard from './parts/OperatorPasswordCard';
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-bold text-rose-600/80 mt-0.5 leading-relaxed">
                                        Your operator profile was not approved. Admin reason: <span className="text-rose-700 font-black">&quot;{rejectionReason}&quot;</span>. Please update your information and save again.
                                    </p>
                                </div>
                            </div>
                        </div>
