...
import { Edit2, CheckCircle2, Briefcase } from 'lucide-react';
...
export default function OperatorContactCard({
    isLocked,
    isEditingMedical,
    setIsEditingMedical,
    medicalForm,
        ...
        <div className="bg-white p-5 lg:p-6 flex flex-col w-full transition-all duration-500 relative group">
            ...
            <div className="flex items-center justify-between border-b border-slate-50 pb-3 mb-5 relative z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-base font-black text-slate-800 tracking-tight">Professional Details</h2>
