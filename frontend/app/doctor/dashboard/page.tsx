                ...
                {isRestricted && (
                    <div className="absolute inset-0 z-30 flex items-center justify-center p-6 bg-white/30 backdrop-blur-sm">
                        <div className="w-full max-w-2xl bg-white rounded-xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 overflow-hidden relative animate-in fade-in zoom-in-95 duration-500 group">
                                ...
                                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <p className="text-slate-500 text-sm md:text-base leading-relaxed font-medium">
                                            {isRejected
                                                ? "Your doctor profile was not approved by the administrator. Please review the reason in your profile settings and update your information."
                                                : isPending
                                                ...
                                                : "To access the specialist dashboard and patient diagnostics, we need to verify your medical credentials. Please complete your doctor profile."}
                                        </p>
                                        <div className="pt-4 flex flex-col md:flex-row items-center gap-4">
                                            ...
                                            >
                                                ...
                                                <div className="absolute inset-0 bg-gradient-to-r from-rose-500 to-red-500 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                                            </Link>
                            ...
                            <div className="bg-slate-50 border-t border-slate-100 p-4 text-center md:text-left transition-colors group-hover:bg-rose-50/50">
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center justify-center md:justify-start gap-2 group-hover:text-rose-600 transition-colors">
                                    <Stethoscope size={14} />
                                    Specialist Dashboard • {isPending ? "Verification Queue" : isRejected ? "Action Required" : "Locked for New User"}
                                </p>
                            </div>
                        </div>
                    </div>
