    ...
    return (
        <div className="flex items-center justify-center h-screen bg-slate-50 relative">
            ...
            <div className="text-center">
                <h1 className="text-3xl font-black text-slate-800 mb-2">Specialist Dashboard</h1>
                <p className="text-slate-500 font-medium">Welcome to the remote diagnostics workspace.</p>
            </div>
        </div>
    );
}
