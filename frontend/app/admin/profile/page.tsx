                                ...
                                {isEditingUsername ? (
                                    <div className="flex items-center gap-2 w-full max-w-[240px]">
                                        <input
                                            ...
                                            autoFocus
                                        />
                                        <button onClick={handleUpdateUsername} className="p-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-600 shadow-sm transition-colors">
                                            <Save size={14} />
                                        </button>
                            ...
                            <form onSubmit={(e) => { e.preventDefault(); handleUpdatePassword(); }} className="space-y-4 max-w-md mx-auto">
                                ...
                                <div className="pt-2">
                                    <button
                                        ...
                                        className="w-full py-3 bg-slate-900 text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all active:scale-95 flex items-center justify-center gap-3"
                                    >
                                        {isUpdatingPassword ? (
                                            <>
