        ...
        <div className="flex flex-col h-full w-full bg-white overflow-hidden relative">
            <div className="h-[72px] shrink-0 border-b border-slate-100 flex items-center justify-between px-8 bg-white/80 backdrop-blur-md z-20">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-slate-800 tracking-tight leading-none">User Approvals</h1>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Pending verification queue</p>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-8 bg-slate-50/30">
                {loading && pendingUsers.length === 0 ? (
                    <div className="h-full w-full flex flex-col items-center justify-center py-20">
                        ...
                        <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Loading queue...</p>
                    </div>
                        ...
                        {filteredUsers.map((user) => (
                            ...
                            >
                                ...
                                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button 
                                            onClick={() => user.id && handleRejectClick(user.id, user.full_name || user.username)}
                                        ...
                                        <button 
                                            onClick={() => user.id && handleApproveClick(user.id, user.full_name || user.username)}
