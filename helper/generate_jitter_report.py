...
# Garis Ungu
ax_plot.plot(df_resampled.index, df_resampled['jitter_ms'], color='#8b5cf6', label='Stabilitas Jitter', linewidth=2)

# Styling
ax_plot.set_title('2. Connection Stability (Jitter)', fontsize=14, fontweight='bold', loc='left', color='#334155')
ax_plot.set_ylabel('Jitter (ms)')
ax_plot.axhline(y=30, color='#f59e0b', linestyle='--', linewidth=1, label='Target Ideal (30ms)')
...
ax_text.text(0.1, 0.5, summary_text, fontsize=11, verticalalignment='center', 
             bbox=dict(boxstyle="round,pad=1", facecolor='#8b5cf6', alpha=0.1, edgecolor='#8b5cf6'))
