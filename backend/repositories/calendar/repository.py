    ...
    def get_nodes(
        ...
        if year is None:
            ...
            if not years_found:
                ...
                return self._build_nodes([], current_year, current_year + 1, "year")
            ...
            return self._build_nodes(results, 1, 13, "month")
            ...
            return self._build_nodes(results, 1, last_day + 1, "day")
            ...
            return self._build_nodes(results, 0, 24, "hour")
            ...
            return self._build_nodes(results, 0, 60, "minute")
            ...
            return self._build_nodes(results, 0, 60, "second")
